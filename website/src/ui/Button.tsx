...
export const button = tv({
  base: "relative cursor-pointer inline-flex items-center justify-center transition-all ty-label-lg ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  variants: {
    variant: {
      default:
      ...
      ghost: "text-muted-front hover:bg-front/10 hover:text-front",
